...
declare -A akita_value_prop=(
        ...
        ["ro.build.display.id"]="akita-eng 99.87.36 AP3A.241005.015 eng.trijal.20240907.130349 test-keys"
        ["ro.build.flavor"]="akita-eng"
        ["ro.build.product"]="akita"
        ["ro.build.description"]="akita-user 14 AP2A.240805.005 12025142 release-keys"
...
modules_touch_install(){
    modules_touch="goodixfp heatmap goog_touch_interface goodix_brl_touch fps_touch_handler"
